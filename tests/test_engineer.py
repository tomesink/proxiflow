...
class TestFeatureScaling():
    ...
    def test_no_columns(self, engineer, df):
        ...
        """
        with pytest.raises(ValueError, match="All columns specified for normalization are missing in the DataFrame."):
            engineer.feature_scaling(df, [], 2)
    ...
    def test_single_degree(self, engineer, df):
        ...
        """
        expected = df.with_column((pl.col("A") ** 2).alias("A_2"))
